...
# Training Colab
# https://colab.research.google.com/drive/17r5n14LYAj2O2IldUiSCU4t5JMSKLpbC#scrollTo=9osUMmompwl2

model_files = [
    {   
        'id': "1-3CNTWKyq0Jl1xQGMf4cefLo7NJKJfwp",
        'fname': "TEXT.Field", 
    },
    {   
        'id': "1-1ffCC5jxlqOEQ-IcFtUyHgMgc-_Ymn2",
        'fname': "LABEL.Field", 
    },
    {   
        'id': "1-JrZfMja_7wA3QBE5LdxNhbKxyQOW-dl",
        'fname': "cmtt_ner_model.pt", 
    }
]
...
class BiLSTM_HINENG_NER():
    ...
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load(os.path.join(path/'models', "cmtt_ner_model.pt"), map_location=torch.device('cpu')))
